...
def test_scanner_precision_recall_benchmark():
    ...
    benchmark_dataset: list[tuple[str, list[Any], str | None]] = [
        ...
        (
            "phone",
            ["+44 20 7946 0958", "+49 30 123456", "+90 532 123 45 67", "(555) 123-4567"],
            "phone",
        ),
        ...
        (
            "iban",
            ["TR330006100519786457841326", "DE89370400440532013000", "GB29NWBK60161331926819"],
            "iban",
        ),
        ...
        (
            "shipping_address",
            ["123 Main St, New York, NY", "Atatürk Cad. No:45, Kadıköy, İstanbul"],
            "address",
        ),
        ...
        (
            "password_hash",
            [
                "$argon2id$v=19$m=65536,t=3,p=4$c29tZXNhbHQ$RdescudvJCsgTVBcFLmwHQ",
                "pbkdf2_sha256$260000$secret$salthashvalue12345678901234567890",
            ],
            "password",
        ),
